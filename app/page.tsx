    ...
    >
      ...
      >
        ...
        <div style={{ marginTop: '3rem' }}>
          ...
          <h2 style={{ fontSize: '1.8rem', fontWeight: '500', color: '#d1d5db', marginBottom: '2rem' }}>
      ...
      {/* Intro */}
      <p style={{ maxWidth: '800px', margin: '2rem auto', fontSize: '1.2rem', lineHeight: '1.6', color: '#d1d5db' }}>
