<main style="font-family: sans-serif; background-color: #0f172a; color: #f8fafc; padding: 2rem; max-width: 800px; margin: auto;">

  <h1 style="text-align: center; font-size: 2.5rem; font-weight: bold; margin-bottom: 2rem;">SelvDepot</h1>

  <h2 style="font-size: 1.5rem; font-weight: bold; margin-top: 2rem;">I. Indledning</h2>
  <p>
    ...
    <br /><em>“[...] they’re not Bitcoin holders, they’re holders of Bitcoin IOUs.”</em><br /> – Trace Mayer, tidlig investor og stifter af “Proof of Keys”-bevægelsen
  </p>

  <h2 style="font-size: 1.5rem; font-weight: bold; margin-top: 2rem;">II. Problemet</h2>
  <p>
  ...
  <p>
    Men den største risiko er slet ikke at eje bitcoin og forblive i det nuværende fiat-system –
    et system præget af inflation, konfiskatoriske tiltag og faldende reel købekraft.
    <br /><br />
    <strong>“Not your keys, not your coins.”</strong>
  </p>

  <h2 style="font-size: 1.5rem; font-weight: bold; margin-top: 2rem;">III. Løsningen</h2>
  <p>
    Hos SelvDepot lærer du ikke blot om principperne bag Bitcoin og self-custody – vi udvikler sammen en personlig, dokumenteret og
    sikker opsætning 1:1, der sikrer dine Bitcoin.
    <br /><br />
    Opsætningen inkluderer også arveplanlægning, så dine nærmeste har mulighed for adgang i tilfælde af sygdom, ulykke eller dødsfald –
    uden at du på noget tidspunkt mister kontrol.
    <br /><br />
  ...
  <h2 style="font-size: 1.5rem; font-weight: bold; margin-top: 2rem;">IV. Udbytte</h2>
  ...
  <h2 style="font-size: 1.5rem; font-weight: bold; margin-top: 2rem;">V. Hvorfor vælge SelvDepot?</h2>
  <p>Vi er:</p>
  <ul style="margin-left: 1.5rem; list-style-type: disc;">
  ...
  <p><strong>Vi rører aldrig dine bitcoin.<br />Vi lærer dig at eje dem selv – for evigt.</strong></p>

  <h2 style="font-size: 1.5rem; font-weight: bold; margin-top: 2rem;">VI. Næste skridt</h2>
  <p>
    ...
    <br /><br />
    <a href="https://calendly.com/selvdepot/30min" target="_blank" style="color: #38bdf8; text-decoration: underline;">
    ...
    <br /><br />
    Velkommen til…<br /><strong>– SelvDepot ₿</strong>
  </p>
