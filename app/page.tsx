  ...
  const pitchContent = [
    {
      ...
      content: (
        <>
          <p>"Bitcoin er ikke bare en investering – det er din økonomiske livsforsikring." SelvDepot er rådgivning i sikker, privat og fremtidssikret opbevaring af Bitcoin.</p>
    ...
    >
      ...
      <img
        ...
        style={{
          ...
          top: '1rem',
          left: '1rem',
          maxWidth: '200px', // Lidt større end de 150px fra tidligere
          height: 'auto',
          borderRadius: '4px',
      ...
      {/* Pitch-sektioner flyttet til top-venstre */}
      ...
      <p style={{ marginTop: '2rem', fontSize: '1rem', textAlign: 'center', lineHeight: '1.5' }}>
        Ingen mellemled. Ingen bureaukrati. Kun dig og dine Bitcoin på dine præmisser. Dine penge. Din fremtid. Din familie. Tag kontrol.
      </p>
      ...
      {/* Sekundær CTA med justeret udseende */}
      <div style={{ marginTop: '2rem', textAlign: 'center', display: 'flex', justifyContent: 'center' }}>
        <p style={{ margin: '0 1rem 0 0', color: '#facc15', fontStyle: 'italic', fontSize: '0.9rem', lineHeight: '1.5' }}>
