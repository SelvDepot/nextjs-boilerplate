  ...
  const pitchContent = [
    {
      ...
      content: (
        <>
          <p>
            Velkommen til MitDepot – dit første skridt mod økonomisk selvstændighed med Bitcoin.
            <br />
    ...
    },
    {
      ...
      content: (
        <>
          <p>
            Mange står over for alvorlige risici, når de opbevarer deres Bitcoin. Her er hvorfor du skal handle nu:
          </p>
          <ul className={styles.pitchList}>
    ...
    },
    {
      ...
      content: (
        <>
          <p>
            Vi tilbyder en personlig tilgang til at sikre dine Bitcoin med følgende løsninger:
          </p>
          <ul className={styles.pitchList}>
    ...
    },
    {
      ...
      content: (
        <>
          <p>
            Med MitDepot får du konkrete fordele, der sikrer din fremtid:
          </p>
          <ul className={styles.pitchList}>
    ...
    },
    {
      ...
      content: (
        <>
          <p>
            Hvad gør os unikke i en verden af Bitcoin-løsninger?
          </p>
          <ul className={styles.pitchList}>
    ...
    },
    {
      ...
      content: (
        <>
          <p>
            Vælg den pakke, der passer til dine behov for sikker Bitcoin-opbevaring:
          </p>
          <div className={styles.packagesContainer}>
            <div className={`${styles.packageRow} grid grid-cols-1 md:grid-cols-3 gap-6`}>
        ...
        <div className="max-w-3xl mx-auto">
          ...
          <ul className={styles.pitchList} style={{ listStyle: 'none' }}>
            <li style={{ marginBottom: '15px', color: '#111827' }}>
              <CheckIconSvg /> 1:1 rådgivning til formuebevidste personer
            </li>
            <li style={{ marginBottom: '15px', color: '#111827' }}>
              <CheckIconSvg /> Fokus på open-source sikkerhed og tilpassede løsninger
            </li>
            <li style={{ color: '#111827' }}>
              <CheckIconSvg /> Ikke hype eller crypto – kun ejerskab og kontrol
            </li>
          </ul>
        </div>
      </section>
