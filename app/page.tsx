  ...
  return (
    ...
    >
      ...
      <div style={{ marginTop: '1rem' }}>
        <a href="/SelvDepot.pdf" download style={{ color: '#60a5fa', textDecoration: 'underline', display: 'block', marginBottom: '1.5rem' }}>
      ...
      {/* Testimonial */}
      <div style={{ marginTop: '2rem', fontStyle: 'italic', color: '#cbd5e1', fontSize: '1rem', borderLeft: '4px solid #facc15', paddingLeft: '1rem' }}>
        “Efter jeg fik hjælp af SelvDepot, sover jeg langt bedre. Nu ved jeg, mine Bitcoin er sikre – og 100% mine.” <br />– Peter, 49 år, Aarhus
      </div>

      {/* Brødtekst */}
      <div style={{ marginTop: '2rem', fontSize: '1rem', lineHeight: '1.6' }}>
        <p style={{ margin: 0 }}>
          Bitcoin self-custody ved hjælp af SelvDepot er din livbåd i en verden hvor det traditionelle FIAT-system suger livet ud af dine beholdninger og aktiver gennem inflation og kontrol. Over 80% af Bitcoin-ejere risikerer at miste alt gennem hacks, social engineering og modpartsrisiko – men DU er stadig den største risiko. Vi lærer dig at eje dine Bitcoin sikkert gennem self-custody inkl. arveplanlægning, trusselsanalyse og multisig – uden at vi nogensinde rører dine private keys. Dette er din sidste udvej før dørene lukker.
        </p>
      </div>
      ...
      {/* Vurderingstekst */}
      <p style={{ marginTop: '2rem', fontSize: '0.9rem', color: '#facc15', fontStyle: 'italic', maxWidth: '600px', marginLeft: 'auto', marginRight: 'auto' }}>
